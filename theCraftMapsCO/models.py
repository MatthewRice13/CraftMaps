...
class Brewery_Table(models.Model):
    ...
    Brewer_Rating = models.DecimalField(max_digits=2, decimal_places=1, default=2.5)
    Brewery_Latitude = models.DecimalField(max_digits=10, decimal_places=8)
    Brewery_Longitude = models.DecimalField(max_digits=10, decimal_places=8)
...
class Beer_Table(models.Model):
    ...
    Beer_Percent = models.DecimalField(max_digits=3, decimal_places=2)
    Beer_Rating = models.DecimalField(max_digits=3, decimal_places=2)
